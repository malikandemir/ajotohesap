...
// Incomes
const Incomes = () => import('@/views/incomes/Incomes')
const Income = () => import('@/views/incomes/Income')
const EditIncome = () => import('@/views/incomes/EditIncome')
const CreateIncome  = () => import('@/views/incomes/CreateIncome')

// Expenses
const Expenses = () => import('@/views/expenses/Expenses')
const Expense = () => import('@/views/expenses/Expense')
const EditExpense = () => import('@/views/expenses/EditExpense')
const CreateExpense  = () => import('@/views/expenses/CreateExpense')

// Expenses
const Payments = () => import('@/views/payments/Payments')
const Payment = () => import('@/views/payments/Payment')
const EditPayment = () => import('@/views/payments/EditPayment')
const CreatePayment  = () => import('@/views/payments/CreatePayment')
