...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::resource('payments', 'PaymentController')->except( ['create', 'store'] );
    Route::post('payments/store',   'PaymentController@store');

    Route::get('expenses/report',   'ExpenseController@report');
    Route::resource('expenses', 'ExpenseController')->except( ['create', 'store'] );
    Route::post('expenses/store',   'ExpenseController@store');

    Route::get('incomes/report',   'IncomeController@report');
    Route::resource('incomes', 'IncomeController')->except( ['create', 'store'] );
